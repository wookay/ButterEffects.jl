...
#
# ~/.julia/dev/ButterEffects main✔   ln -s  JULIA_SOURCE_PATH  sources
...
check_the_code_block_diff(
    "ext/REPLExt.jl",
    :(module REPLExt function _helpmode(io::Base.TTY, line::AbstractString, mod::Module=Main, internal_accesses::Union{Nothing, Set{Pair{Module,Symbol}}}=nothing) end end),
    "sources/stdlib/REPL/src/docview.jl",
    :(function _helpmode(io::IO, line::AbstractString, mod::Module=Main, internal_accesses::Union{Nothing, Set{Pair{Module,Symbol}}}=nothing) end) ;
    skip_lines = (src = Int[2], dest = Int[])
)
